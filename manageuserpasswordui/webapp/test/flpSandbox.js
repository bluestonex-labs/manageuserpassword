		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#ukcobrakesrfmanageuserpasswordui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ukcobrakesrfmanageuserpasswordui-display": {
								"semanticObject": "ukcobrakesrfmanageuserpasswordui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=uk.co.brakes.rf.manageuserpasswordui",
									"url": sap.ui.require.toUrl("uk/co/brakes/rf/manageuserpasswordui")
								}
							}
						}
					}
